...
public class ABEVerifyCorporateCustomerPage {
	...
	private By corporateradioButton = By.xpath("(//input[@id='_corpCif_radio'])[1]");
	private By operationApproveDropDownList = By.xpath("(//select[@id='_operation_select'])[1]");
	private By customerTypeDropDownList = By.xpath("(//select[@id='_entType_select'])[1]");
	...
	public ABEVerifyCorporateCustomerPage(WebDriver driver) {
		this.driver = driver;
	}
	
	@Step("Sending menu name: {0}")
	public ABEVerifyCorporateCustomerPage sendKeysSearchBarTextField(String menu) throws Exception {
	...
	public ABEVerifyCorporateCustomerPage switchFormAreaFrame() throws Exception {
		driver.switchTo().parentFrame();
	...
	public ABEVerifyCorporateCustomerPage enterDataAtRCCAT(String cif, String customerType) throws Exception{
		...
		PageFunctionUtils.selectDropDownListByVisibleText(driver, customerTypeDropDownList, customerType);
	...
	@Step("Approve CIF")
	public ABEVerifyCorporateCustomerPage approveCIF() throws Exception{
	...
	public ABEVerifyCorporateCustomerPage openCorporateCustomerFirstPage() throws Exception {
	...
	@Step("Approval Form")
	public ABEVerifyCorporateCustomerPage approvalForm()throws Exception{
