...
public class ABEIssueOutwardLGTradeFinancePage {
	...
	private By guaranteeContinueButtonL = By.xpath("(//button[@id='_ogmguarntee_guarentedet_Continue'])[1]");

	private By guaranteeContinueButtonF = By.xpath("(//button[@id='_ogmguarntee_guarentedet_Continue'])[1]");  
	...
	private By operationAmountTextField = By.xpath("(//input[@id='_ogmgendtls_opAmt$amt'])[1]");
	private By nonOperationAmountTextField = By.xpath("(//input[@id='_ogmgendtls_nonopAmt$amt'])[1]");
	...
	private By editFirstButtonFBIDG = By.xpath("(//span[@class='editcontent'])[5]");	
	private By editSecondButtonFBIDG = By.xpath("(//span[@class='editcontent'])[6]");
	private By editNarrativeButtonFBIDG  = By.xpath("(//span[@class='editcontent'])[9]");
	
	
	
	private By editFirstButtonFPERG = By.xpath("(//span[@class='editcontent'])[3]");	
	private By editSecondButtonFPERG = By.xpath("(//span[@class='editcontent'])[4]");
	private By editNarrativeButtonFPERG = By.xpath("(//span[@class='editcontent'])[7]");
   ...
   @Step("Enter operational amounts")
   public ABEIssueOutwardLGTradeFinancePage enterOperationalAmounts(String operationalAmount) throws Exception{
	   PageFunctionUtils.waitOnElement(driver, operationAmountTextField);
	   PageFunctionUtils.clickOnElement(driver, operationAmountTextField);
	   PageFunctionUtils.clearDataInWebElement(driver, operationAmountTextField);
	   PageFunctionUtils.enterDataInWebElement(driver, operationAmountTextField, operationalAmount.substring(1));	
	   return this;
   }
   
   @Step("Enter non operational amounts")
   public ABEIssueOutwardLGTradeFinancePage enterNonOperationalAmounts(String nonOperationalAmount) throws Exception{
	   PageFunctionUtils.waitOnElement(driver, nonOperationAmountTextField);
	   PageFunctionUtils.clickOnElement(driver, nonOperationAmountTextField);
	   PageFunctionUtils.clearDataInWebElement(driver, nonOperationAmountTextField);
	   PageFunctionUtils.enterDataInWebElement(driver, nonOperationAmountTextField, nonOperationalAmount.substring(1));	
	   return this;
   }
  ...
  public ABEIssueOutwardLGTradeFinancePage selectApplicableRules(String rulesdropdown) throws Exception{
	 ...
	 @Step("click on counter guarantee details menu")
	  public ABEIssueOutwardLGTradeFinancePage closeCounterGuranteeMenu() throws Exception{
		    PageFunctionUtils.waitOnElement(driver, counterGuaranteeDetailsMenu);
			PageFunctionUtils.clickOnElement(driver, counterGuaranteeDetailsMenu);
...
public ABEIssueOutwardLGTradeFinancePage pressOnGuaranteeDetailsContinueButton() throws Exception{	
	PageFunctionUtils.waitOnFrameAndSwitchXpath(driver, formAreaIframeID);
...
@Step("press on guarantee continue button")
public ABEIssueOutwardLGTradeFinancePage pressOnGuaranteeContinueButtonL() throws Exception{		
	PageFunctionUtils.waitOnElement(driver, guaranteeContinueButtonL);
	PageFunctionUtils.clickOnElement(driver, guaranteeContinueButtonL);
...
@Step("press on guarantee continue button")
public ABEIssueOutwardLGTradeFinancePage pressOnGuaranteeContinueButtonF() throws Exception{	
	PageFunctionUtils.waitOnFrameAndSwitchXpath(driver, formAreaIframeID);
	PageFunctionUtils.waitOnElement(driver, guaranteeContinueButtonF);
	PageFunctionUtils.clickOnElement(driver, guaranteeContinueButtonF);
...
@Step("Click on first edit button")
public ABEIssueOutwardLGTradeFinancePage clickOnFirstEditButtonFBIDG() throws Exception{
	  PageFunctionUtils.waitOnElement(driver, editFirstButtonFBIDG);
	  PageFunctionUtils.clickOnElement(driver, editFirstButtonFBIDG);
	return this;
}
...
@Step("Click on first edit button")
public ABEIssueOutwardLGTradeFinancePage clickOnFirstEditButtonFPERG() throws Exception{
	  PageFunctionUtils.waitOnElement(driver, editFirstButtonFPERG);
	  PageFunctionUtils.clickOnElement(driver, editFirstButtonFPERG);
	return this;
}
...
@Step("Click on second edit button")
public ABEIssueOutwardLGTradeFinancePage clickOnSecondEditButtonFBIDG() throws Exception{
	  PageFunctionUtils.waitOnElement(driver, editSecondButtonFBIDG);
	  PageFunctionUtils.clickOnElement(driver, editSecondButtonFBIDG);
	return this;
}
...
@Step("Click on second edit button")
public ABEIssueOutwardLGTradeFinancePage clickOnSecondEditButtonFPERG() throws Exception{
	  PageFunctionUtils.waitOnElement(driver, editSecondButtonFPERG);
	  PageFunctionUtils.clickOnElement(driver, editSecondButtonFPERG);
	return this;
}
...
@Step("Click on edit narrative button")
public ABEIssueOutwardLGTradeFinancePage clickOnEditNarrativeButtonFBIDG() throws Exception{
	
	 PageFunctionUtils.waitOnElement(driver, editNarrativeButtonFBIDG);
	 PageFunctionUtils.clickOnElement(driver, editNarrativeButtonFBIDG);
	return this;
}
...
@Step("Click on edit narrative button")
public ABEIssueOutwardLGTradeFinancePage clickOnEditNarrativeButtonFPERG() throws Exception{
	
	 PageFunctionUtils.waitOnElement(driver, editNarrativeButtonFPERG);
	 PageFunctionUtils.clickOnElement(driver, editNarrativeButtonFPERG);
	return this;
}
