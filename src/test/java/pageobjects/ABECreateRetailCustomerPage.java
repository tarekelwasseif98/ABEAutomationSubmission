...
public class ABECreateRetailCustomerPage {
	...
	private By goButton = By.xpath("/html[1]/body[1]/fin-html-body[1]/div[1]/div[5]/div[2]/div[1]/div[1]/div[1]/div[2]/div[1]/load-script[1]/div[1]/ng-include[1]/fin-full-width[1]/div[1]/div[1]/div[4]/div[1]/ux-form[1]/div[1]/ng-transclude[1]/div[1]/div[1]/div[2]/div[1]/div[2]/fin-explode-button[1]/button[1]");
	...
	private By addressType = By.xpath("//select[@id='_pgaddressdet_addtype_select']");
	...
	private By countryCodeAddressTextField = By
			.xpath("(//input[@id='_pgaddressdet_crmaddress$otherDetailsCountry'])[1]");
	private By editAddressIconButton = By.xpath("//i[normalize-space()='edit']");
	private By deleteAddressbutton2 = By.xpath("(//i[@class='material-icons'][normalize-space()='delete'])[2]");
	...
	private By proceedToEnrichButton = By.xpath("//button[@id='_prdEnrich']");
	...
	private By amlXButtonENRICH = By
	...
	private By addemailPluseButtonENRICH = By.xpath(
			"//button[@id='_dg_phemail_AddRecBtn_label']//i[@class='material-icons'][normalize-space()='add_circle']");
	...
	private By employerNameTextFieldENRICH = By.xpath("/html/body/fin-html-body/div/div[5]/div[2]/div/div/div[1]/div[3]/div/load-script/div/ng-include/fin-split-pane/div/div/div[4]/div[2]/ux-form/div/ng-transclude/div/div/div[1]/div/div[3]/div[2]/div/div/div[2]/div[1]/fin-text-input/div/ng-transclude/input");
	...
	private By dataIncomeUnemployedTextFieldENRICH = By.xpath("//textarea[@id='_moredetails_textArea']");
	...
	private By riskDetailsSideMenuButtonENRICH = By.xpath("(//span[@title='Risk Details'])[1]");
	...
	private By pepDetailsSubmenuENRICH = By.xpath("(//h3[normalize-space()='PEP Details'])[1]");
	...
	private By fatcaDetailsENRICH = By.xpath("//span[@title='FATCA Details']");
	private By continueRiskDetailsButtonENRICH = By.id("_btncontinue2");
	...
	private By saveAndValidateGeneralDetailsENRICH = By.xpath("//button[@id='_btnSavenval']");
	...
	private By financeDetailsDropdownList4ENRICH = By.xpath("//select[@id='_sourceoffunds_select']");
	...
	public ABECreateRetailCustomerPage openRetailCustomerFristPage(String docType, String docNumber) throws Exception {
		...
		PageFunctionUtils.scrollUpToElement(driver, goButton);
	...
	@Step("Enter AR NATIONAL Customer Name")
	public ABECreateRetailCustomerPage enterARNationalCustomerName(String midARname) throws Exception {
		PageFunctionUtils.clickOnElement(driver, middleNameARtextField);
		driver.findElement(middleNameARtextField).sendKeys("تيست");
		// PageFunctionUtils.enterDataInWebElement(driver, middleNameARtextField,
		// midARname);
		return this;
	}
	...
	@Step("Add Address Customer Passport")
	public ABECreateRetailCustomerPage addAddressCustomerPASS(String addressLine1, String cityAddress, String governorate,
	...
	public ABECreateRetailCustomerPage addAddressCustomer(String addressLine1, String cityAddress, String governorate,
		...
		PageFunctionUtils.sleep();
		WebDriverWait wait = new WebDriverWait(driver, 10);
		PageFunctionUtils.clickOnElement(driver, deleteAddressbutton2);
	...
	public ABECreateRetailCustomerPage addWorkAddressCustomer(String addressLine1, String cityAddress,
			String governorate, String country) throws Exception {

		PageFunctionUtils.sleep();
//      ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", addAddressButton);
		PageFunctionUtils.clickOnElement(driver, addAddressButton);
		PageFunctionUtils.waitOnElement(driver, addressLine1TextField);
		PageFunctionUtils.selectDropDownListByIndex(driver, addressType, 1);
		PageFunctionUtils.enterDataInWebElement(driver, addressLine1TextField, addressLine1);
		PageFunctionUtils.enterDataInWebElement(driver, cityAddressTextField, cityAddress.substring(1));
		PageFunctionUtils.enterDataInWebElement(driver, governorateTextField, governorate.substring(1));
		PageFunctionUtils.enterDataInWebElement(driver, countryCodeAddressTextField, country);
	...
	public ABECreateRetailCustomerPage fillResidentialDetails(String residencyStatus, String resindencExpiryDate,
		...
		PageFunctionUtils.enterDataInWebElement(driver, resindencExpiryDateText, resindencExpiryDate);
	...
	public ABECreateRetailCustomerPage saveCIF(String linkedId) throws Exception {
		...
		if (rowByTcid1 != -1 && rowByTcid2 != -1) {
			CSVUtils.insertValueInCsvCell(Paths.ABECREATERETAILCUSTOMERCSV, rowByTcid1, columnByColumnName1, cif);
			 CSVUtils.insertValueInCsvCell(Paths.ABEVERIFYRETAILCUSTOMERCSV, rowByTcid2,columnByColumnName2,cif);
	...
	@Step("Open General PASSPORT Details")
	public ABECreateRetailCustomerPage generalDetailsOptionPassport(String placeOfBirth) throws Exception {
	...
	@Step("Open General NATID Details")
	public ABECreateRetailCustomerPage generalDetailsOptionNATID() throws Exception {
		PageFunctionUtils.clickOnElement(driver, generalDetailsButtonlinkENRICH);
		PageFunctionUtils.clickOnElement(driver, amlButtonScreenCheckENRICH);
		PageFunctionUtils.waitOnElement(driver, amlXButtonENRICH);
		PageFunctionUtils.clickOnElement(driver, amlXButtonENRICH);
	...
	@Step("Occupation Details At ENRICH")
	public ABECreateRetailCustomerPage occupationDetailsABEStaff() throws Exception {
		PageFunctionUtils.clickOnElement(driver, emplomentDetailsSubMenuENRICH);
		driver.findElement(employerNameTextFieldENRICH).sendKeys("ABE");
		PageFunctionUtils.selectDropDownListByIndex(driver, politicalOccupationList1ENRICH, 2);
		PageFunctionUtils.selectDropDownListByIndex(driver, politicalOccupationList2ENRICH, 2);
		PageFunctionUtils.clickOnElement(driver, continueButtonENRICH);
		return this;
	...
	@Step("ABE Specfic")
	public ABECreateRetailCustomerPage abeSpecficData(String payrollFlag, String payRollCustomerCompanyID)
			throws Exception {
		PageFunctionUtils.waitOnElement(driver, poaDropDownListENRICH);
	...
	public ABECreateRetailCustomerPage riskDetailsCountryDealing(String categoryCodecountryDealing) throws Exception {
		...
		PageFunctionUtils.enterDataInWebElement(driver, categoryCodecountryDealingTextFieldENRICH,
				categoryCodecountryDealing);
	...
	@Step("PEP Y")
	public ABECreateRetailCustomerPage pepselection() throws Exception {
		...
		driver.findElement(pepTextField1ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField2ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField3ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField4ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField5ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField6ENRICH).sendKeys("TEST");
		driver.findElement(pepNumberField7ENRICH).sendKeys("1000");
		driver.findElement(pepNumberField8ENRICH).sendKeys("1000");
		driver.findElement(pepNumberField9ENRICH).sendKeys("1000");
		driver.findElement(pepNumberField10ENRICH).sendKeys("1000");
		PageFunctionUtils.clickOnElement(driver, pepDetailsSubmenuENRICH);
		driver.findElement(pepTextField11ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField12ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField13ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField14ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField15ENRICH).sendKeys("TEST");
		driver.findElement(pepDateTextField16ENRICH).sendKeys("24112023");
		PageFunctionUtils.clickOnElement(driver, fatcaDetailsENRICH);
		return this;
	}

	@Step("PEP N PASS")
	public ABECreateRetailCustomerPage pepunSelectedPASS() throws Exception {
	...
	@Step("Contniue Risk Button")
	public ABECreateRetailCustomerPage contniueRiskButton() throws Exception {
		PageFunctionUtils.waitOnElement(driver, continueRiskDetailsButtonENRICH);
		PageFunctionUtils.clickOnElement(driver, continueRiskDetailsButtonENRICH);
		return this;
	}

	@Step("High Risk Customer Passport")
	public ABECreateRetailCustomerPage highRiskPassportCustomer() throws Exception {

		PageFunctionUtils.clickOnElement(driver, pepTextField1ENRICH);
		driver.findElement(pepTextField1ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField2ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField3ENRICH).sendKeys("TEST");
		driver.findElement(pepTextField4ENRICH).sendKeys("TEST");
	...
	public ABECreateRetailCustomerPage saveAndValidateGeneralDetails() throws Exception {
	...
	public ABECreateRetailCustomerPage openBankDefinedDetails() throws Exception {
		...
		PageFunctionUtils.clickOnElement(driver, saveAndValidateBankDefinedDetailsButtonENRICH);
		PageFunctionUtils.clickOnElement(driver, viewSummaryButtonENRICH);
		return this;
	}
	...
	public ABECreateRetailCustomerPage openfinancialDetail() throws Exception {
		...
		PageFunctionUtils.waitOnElement(driver, continueFinancialDetailsButtonENRICH);
		PageFunctionUtils.clickOnElement(driver, continueFinancialDetailsButtonENRICH);
		driver.findElement(depositeAmountFinanicalDetailsTextFieldENRICH).sendKeys("1000");
		PageFunctionUtils.selectDropDownListByIndex(driver, financeDetailsDropdownList1ENRICH, 1);
		PageFunctionUtils.selectDropDownListByIndex(driver, financeDetailsDropdownList2ENRICH, 10);
		PageFunctionUtils.selectDropDownListByIndex(driver, financeDetailsDropdownList3ENRICH, 10);
		PageFunctionUtils.waitOnElement(driver, financeDetailsDropdownList4ENRICH);
		PageFunctionUtils.selectDropDownListByIndex(driver, financeDetailsDropdownList4ENRICH, 10);
		PageFunctionUtils.clickOnElement(driver, saveAndValidateFinancialDetailsButtonENRICH);
