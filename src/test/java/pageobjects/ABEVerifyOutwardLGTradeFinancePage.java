...
public class ABEVerifyOutwardLGTradeFinancePage {
	...
	//FPERG //OCBID
	private By viewFirstMessageButtonFO = By.xpath("(//span[@class='viewcontent'])[3]");
	private By viewSecondMessageButtonFO = By.xpath("(//span[@class='viewcontent'])[4]");
	
	//FBIDG
	private By viewFirstMessageButtonFBIDG = By.xpath("(//span[@class='viewcontent'])[5]");
	private By viewSecondMessageButtonFBIDG = By.xpath("(//span[@class='viewcontent'])[6]");
	...
	public ABEVerifyOutwardLGTradeFinancePage pressFirstViewMessageButtonFO() throws Exception {	
		PageFunctionUtils.waitOnElement(driver, viewFirstMessageButtonFO);
		PageFunctionUtils.clickOnElement(driver, viewFirstMessageButtonFO);
		return this;
}
...
//FBIDG
	...
	@Step("press on first view message button")
	public ABEVerifyOutwardLGTradeFinancePage pressFirstViewMessageButtonFBIDG() throws Exception {	
		PageFunctionUtils.waitOnElement(driver, viewFirstMessageButtonFBIDG);
		PageFunctionUtils.clickOnElement(driver, viewFirstMessageButtonFBIDG);
		return this;
}
	...
	public ABEVerifyOutwardLGTradeFinancePage pressSecondViewMessageButtonFO() throws Exception {	
		PageFunctionUtils.waitOnElement(driver, viewSecondMessageButtonFO);
		PageFunctionUtils.clickOnElement(driver, viewSecondMessageButtonFO);
		return this;
}	
	
	
	@Step("press on second view message button")
	public ABEVerifyOutwardLGTradeFinancePage pressSecondViewMessageButtonFBIDG() throws Exception {	
		PageFunctionUtils.waitOnElement(driver, viewSecondMessageButtonFBIDG);
		PageFunctionUtils.clickOnElement(driver, viewSecondMessageButtonFBIDG);
		return this;
}		
