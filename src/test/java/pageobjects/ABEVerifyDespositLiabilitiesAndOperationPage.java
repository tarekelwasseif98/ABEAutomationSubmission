...
public class ABEVerifyDespositLiabilitiesAndOperationPage {
	...
	public ABEVerifyDespositLiabilitiesAndOperationPage(WebDriver driver) {
		this.driver = driver;
	}
	
	@Step("Sending menu name: {0}")
	public ABEVerifyDespositLiabilitiesAndOperationPage sendKeysSearchBarTextField(String menu) throws Exception {
	...
	public ABEVerifyDespositLiabilitiesAndOperationPage switchFormAreaFrame() throws Exception {
	...
	public ABEVerifyDespositLiabilitiesAndOperationPage selectFuntionCodeType() throws Exception {
	...
	@Step("Sending Deposit ID: {0}")
	public ABEVerifyDespositLiabilitiesAndOperationPage sendKeysAccountId(String accountId ) throws Exception {
	...
	public ABEVerifyDespositLiabilitiesAndOperationPage pressGoButton() throws Exception {
		PageFunctionUtils.clickOnElement(driver,GoButton);
		try{PageFunctionUtils.clickOnElement(driver,GoButton);}catch(Exception e) {}

		return this;	
	}
	
	@Step("press submit button")
	public ABEVerifyDespositLiabilitiesAndOperationPage pressSubmitButton() throws Exception {
	...
	public ABEVerifyDespositLiabilitiesAndOperationPage getSuccessMessageText() throws Exception {
	...
	@Step("Handle alert")
	public ABEVerifyDespositLiabilitiesAndOperationPage handleAlert() throws Exception {
		driver.switchTo().parentFrame();
	...
	public ABEVerifyDespositLiabilitiesAndOperationPage submitAssertion() throws Exception {
		PageFunctionUtils.waitOnFrameAndSwitchXpath(driver, formAreaIframeID);
		PageFunctionUtils.scrollUp(driver);
		driver.switchTo().parentFrame();
