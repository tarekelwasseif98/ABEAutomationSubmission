...
public class ABETradeFinanceImportBillsLodgeVerifyPage {
	...
	public ABETradeFinanceImportBillsLodgeVerifyPage(WebDriver driver) {
		this.driver = driver;
	}
	

	@Step("Sending menu name: {0}")
	public ABETradeFinanceImportBillsLodgeVerifyPage sendKeysSearchBarTextField(String menu) throws Exception {
	...
	public ABETradeFinanceImportBillsLodgeVerifyPage switchFormAreaFrame() throws Exception {
	...
	public ABETradeFinanceImportBillsLodgeVerifyPage sendKeysBillId(String billId) throws Exception {
	...
	public ABETradeFinanceImportBillsLodgeVerifyPage pressGoButton() throws Exception {
	...
	public ABETradeFinanceImportBillsLodgeVerifyPage pressSubmitButton() throws Exception {
	...
	public ABETradeFinanceImportBillsLodgeVerifyPage pressSideTab1() throws Exception {
	...
	@Step("press side tabs: {0}")
	public ABETradeFinanceImportBillsLodgeVerifyPage pressSideTab2() throws Exception {
	...
	@Step("press side tabs: {0}")
	public ABETradeFinanceImportBillsLodgeVerifyPage pressSideTab3() throws Exception {
	...
	@Step("press side tabs: {0}")
	public ABETradeFinanceImportBillsLodgeVerifyPage pressSideTab4() throws Exception {
	...
	@Step("press side tabs: {0}")
	public ABETradeFinanceImportBillsLodgeVerifyPage pressSideTab5() throws Exception {
	...
	@Step("press side tabs: {0}")
	public ABETradeFinanceImportBillsLodgeVerifyPage pressSideTab6() throws Exception {
	...
	@Step("press side tabs: {0}")
	public ABETradeFinanceImportBillsLodgeVerifyPage pressSideTab7() throws Exception {
	...
	public ABETradeFinanceImportBillsLodgeVerifyPage id1Attribute() throws Exception {
	...
	public ABETradeFinanceImportBillsLodgeVerifyPage id2Attribute() throws Exception {
	...
	public ABETradeFinanceImportBillsLodgeVerifyPage pressTenorDetailsViewButton1() throws Exception {
	...
	@Step("Press tenor details view button")
	public ABETradeFinanceImportBillsLodgeVerifyPage pressTenorDetailsViewButton2() throws Exception {
		try {
	...
	public ABETradeFinanceImportBillsLodgeVerifyPage pressTenorDetailsCloseButton() throws Exception {
		try {
		...
		@Step("Save bill id")
	public ABETradeFinanceImportBillsLodgeVerifyPage saveBillId(String acceptLinkedTcid, String verifyAcceptLinkedTcid, String realizeLinkedTcid, String verifyRealizeLinkedTcid,String coAcceptLinkedTcid, String verifyCoAcceptLinkedTcid) throws Exception {
