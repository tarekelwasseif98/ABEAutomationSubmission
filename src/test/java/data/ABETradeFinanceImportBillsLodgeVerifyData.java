...
public class ABETradeFinanceImportBillsLodgeVerifyData {
	...
	public String toString() {
		return "ABETradeFinanceImportBillsLodgeVerifyData [tcId=" + tcId + ", summary=" + summary + ", username="
				...
				+ verifyRealizeLinkedTcid + ", coAcceptLinkedTcid=" + coAcceptLinkedTcid + ", verifyCoAcceptLinkedTcid="
				+ verifyCoAcceptLinkedTcid + "]";
	}
