...
public class ABECoAcceptImportBillsTradeFinanceData {
	private String tcId;
	...
	private String CoacceptanceDate;
	...
	public String getCoacceptanceDate() {
		return CoacceptanceDate;
	}
	public void setCoacceptanceDate(String coacceptanceDate) {
		CoacceptanceDate = coacceptanceDate;
	}
	...
	public String toString() {
		return "ABECoAcceptImportBillsTradeFinance [tcId=" + tcId + ", summary=" + summary + ", username=" + username
				+ ", password=" + password + ", menu=" + menu + ", billId=" + billId + ", mixedBillId1=" + mixedBillId1
				+ ", mixedBillId2=" + mixedBillId2 + ", acceptanceDate=" + acceptanceDate + ", CoacceptanceDate="
				+ CoacceptanceDate + ", expectedResult=" + expectedResult + ", linkedTcid=" + linkedTcid + "]";
	}
