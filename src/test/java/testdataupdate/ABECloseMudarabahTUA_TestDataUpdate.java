...
public class ABECloseMudarabahTUA_TestDataUpdate {
	...
	private static final int[] insertLocation = {160};
	private static final String csvFilePath = Paths.ABECLOSEMUDARABAHTUACSV;
