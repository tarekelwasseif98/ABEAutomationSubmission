...
public class Paths {
	...
	public static final String ABECREATECDLIABILITIESANDOPERATIONCSV  = "csvFiles\\ABECreateCDLiabilitiesAndOperation.csv";
	public static final String ABECREATECDLIABILITIESANDOPERATIONJSON =  "jsonFiles\\" + ABECREATECDLIABILITIESANDOPERATIONCSV.substring(9, Paths.ABECREATECDLIABILITIESANDOPERATIONCSV.length()-4) + ".json";
	...
	public static final String ABEVERIFYCDLIABILITIESANDOPERATIONCSV  = "csvFiles\\ABEVerifyCDLiabilities&Operation.csv";
	public static final String ABEVERIFYCDLIABILITIESANDOPERATIONJSON =  "jsonFiles\\" + ABEVERIFYCDLIABILITIESANDOPERATIONCSV.substring(9, Paths.ABEVERIFYCDLIABILITIESANDOPERATIONCSV.length()-4) + ".json";
	...
	public static final String ABEVERIFYOUTWARDLGTRADEFINANCECSV = "csvFiles\\ABEVerifyOutwardLGTradeFinance.csv";
	public static final String ABEVERIFYOUTWARDLGTRADEFINANCEJSON =  "jsonFiles\\" + ABEVERIFYOUTWARDLGTRADEFINANCECSV.substring(9, Paths.ABEVERIFYOUTWARDLGTRADEFINANCECSV.length()-4) + ".json";
	
	
	public static final String ABEVERIFYINWARDGUARANTEECSV = "csvFiles\\ABEVerifyInwardGuarantee.csv";
	public static final String ABEVERIFYINWARDGUARANTEEJSON = "jsonFiles\\" + ABEVERIFYINWARDGUARANTEECSV.substring(9, Paths.ABEVERIFYINWARDGUARANTEECSV.length()-4) + ".json";
	...
	public static final String ABECoAcceptImportBillsTradeFinanceCsv = "csvFiles\\ABECoAcceptImportBillsTradeFinance.csv";
	public static final String ABECoAcceptImportBillsTradeFinanceJson = "jsonFiles\\" + ABECoAcceptImportBillsTradeFinanceCsv.substring(9, Paths.ABECoAcceptImportBillsTradeFinanceCsv.length()-4) + ".json";

	public static final String ABEVerifyCoAcceptImportBillsTradeFinanceCsv = "csvFiles\\ABEVerifyCoAcceptImportBillsTradeFinance.csv";
	public static final String ABEVerifyCoAcceptImportBillsTradeFinanceJson = "jsonFiles\\" + ABEVerifyCoAcceptImportBillsTradeFinanceCsv.substring(9, Paths.ABEVerifyCoAcceptImportBillsTradeFinanceCsv.length()-4) + ".json";
    
	public static final String ABEADVISEINWARDLCCSV  = "csvFiles\\ABEAdviseInwardLCTradeFinance.csv";
	public static final String ABEVERIFYADVISEINWARDLCCSV= "csvFiles\\ABEVerifyAdviseInwardLCTradeFinance.csv";
	public static final String ABEADVISEINWARDLCJSON =  "jsonFiles\\" + ABEADVISEINWARDLCCSV.substring(9, Paths.ABEADVISEINWARDLCCSV.length()-4) + ".json";
	public static final String ABEVERIFYADVISEINWARDLCJSON = "jsonFiles\\" + ABEVERIFYADVISEINWARDLCCSV.substring(9, Paths.ABEVERIFYADVISEINWARDLCCSV.length()-4) + ".json";
	...
	public static final String ABECREATECORPORATECUSTOMERCSV  = "csvFiles\\ABECreateCorporateCustomer.csv";
	public static final String ABEVERIFYCORPORATECUSTOMERCSV = "csvFiles\\ABEVerifyCorporateCustomer.csv";
	public static final String ABECREATECORPORATECUSTOMERJSON =  "jsonFiles\\" + ABECREATECORPORATECUSTOMERCSV.substring(9, Paths.ABECREATECORPORATECUSTOMERCSV.length()-4) + ".json";
	public static final String ABEVERIFYCORPORATECUSTOMERJSON = "jsonFiles\\" + ABEVERIFYCORPORATECUSTOMERCSV.substring(9, Paths.ABEVERIFYCORPORATECUSTOMERCSV.length()-4) + ".json";	
	...
	public static final String ABEADDINWARDGUARANTEECSV = "csvFiles\\ABEAddInwardGuarantee.csv";
	public static final String ABEADDINWARDGUARANTEEJSON =  "jsonFiles\\" + ABEADDINWARDGUARANTEECSV.substring(9, Paths.ABEADDINWARDGUARANTEECSV.length()-4) + ".json";

	public static final String ABEISSUEOUTWARDLGTRADEFINANCECSV = "csvFiles\\ABEIssueOutwardLGTradeFinance.csv";
	...
	public static final String ABEISSUEOUTWARDLCSsTRADEFINANCECSV = "csvFiles\\ABEIssueOutwardLCsTradeFinance.csv";
