...
public class ABEOpenOVDTest {
	...
	public void oneTimeSetUp() throws IOException, CsvException {
		CSVUtils.clearColumnByName(Paths.ABEOPENOVERDRAFTACCOUNTCSV, "reference");
		CSVUtils.clearColumnByName(Paths.ABEMODIFYOVERDRAFTACCOUNTBEFOREVERIFICATIONCSV, "modifyAccountId");
		CSVUtils.clearColumnByName(Paths.ABEVERIFYOVERDRAFTACCOUNTCSV, "accountId");
	}
	...
	public Object[] dpMethod() throws Exception {
    	Workbook workbook = new Workbook(Paths.ABEOPENOVERDRAFTACCOUNTCSV);
		workbook.save(Paths.ABEOPENOVERDRAFTACCOUNTJSON);
        Class<ABEOpenOVDData> targetClass = ABEOpenOVDData.class;
        JsonReader<ABEOpenOVDData> jsonReader = new JsonReader<>(targetClass);
        List<ABEOpenOVDData> dataList = jsonReader.readJsonFile(Paths.ABEOPENOVERDRAFTACCOUNTJSON);
        dataList.toArray();
